...
\begin{figure}[here]
\begin{center}
    \includegraphics[width=11cm]{Figures/image_2.png} 
\end{center}
...
\begin{figure}[here]
\begin{center}
    \includegraphics[width=11cm]{Figures/image_1.png} 
\end{center}
